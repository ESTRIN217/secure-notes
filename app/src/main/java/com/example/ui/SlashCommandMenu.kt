...
enum class BlockAction { NONE, URL_DIALOG, TABLE_DIALOG, IMAGE_DIALOG, VIDEO_DIALOG, VOICE_FILE_DIALOG, FILE_DIALOG, BOOKMARK_DIALOG, INSERT_PAGE, LINK_PAGE, LINK_INLINE, EQUATION_DIALOG, DRAWING_DIALOG }
...
val BLOCK_COMMANDS: List<BlockCommand> = listOf(
    ...
    BlockCommand(R.string.block_bookmark, R.string.block_bookmark_desc, Icons.Default.Bookmark, BlockSection.MEDIA, action = BlockAction.BOOKMARK_DIALOG),
